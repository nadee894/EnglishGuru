...
<div class="container">
    ...
    <h3>Type a sentence to check grammar mistakes</h3>

    <form role="form" name="myform" id="myform" action="<?php echo base_url('home/checkGrammar')?>" method="post">
        <div class="form-group">

            <textarea class="form-control" rows="2" name="val1" id="val1" placeholder="type a word..."><?php if(isset($id)){echo $id;}?></textarea>
        </div>
        <div class="col-md-12 text-center">
            <button type="submit" class="btn btn-primary btn-lg" value="check">Check Grammar Mistake</button>
        </div>
    </form>
</div>
<script>
